  ...
  final List<Map<String, dynamic>> questions = [
    {
      ...
      'options': ['Schedule an immediate home visit to assess the situation in person and meet with Maria', 'Ask Anna to bring her mother to the office for a formal intake appointment', 'Gather more information from Anna first before deciding on next steps'],
    },
    {
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Column(
                        children: [
                          Icon(Icons.credit_card, color: Color(0xFFA5B800), size: 55),
                          SizedBox(height: 6),
                          Text(
                            '6 cards',
                            style: TextStyle(
