...
class UploadDropzone extends StatelessWidget {
  const UploadDropzone({
    ...
    required this.removeEvidenceLabel,
  ...
  final String removeEvidenceLabel;
  final List<EvidenceItem> selectedEvidence;
  final VoidCallback onTap;
  final ValueChanged<EvidenceItem> onRemoveEvidence;
                          ...
                          children: selectedEvidence
                              .map(
                                (item) => InputChip(
                                  ...
                                  onDeleted: () => onRemoveEvidence(item),
                                  deleteIcon: const Icon(
                                    Icons.close_rounded,
                                    size: 18,
                                  ),
                                  deleteButtonTooltipMessage: removeEvidenceLabel,
                                  backgroundColor: Colors.white,
                                  side: const BorderSide(
                                    color: Color(0xFFD1D1D1),
                                  ),
                                  deleteIconColor: const Color(0xFF7B7B7B),
                                ),
                              )
                              .toList(),
                        ),
