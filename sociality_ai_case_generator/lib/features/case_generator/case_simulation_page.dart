...
class CaseSimulationPage extends StatelessWidget {
  ...
  void _openStepOverlay(
    ...
    showGeneralDialog<void>(
      ...
      barrierLabel: copy.stepDetailsBarrierLabel,
      barrierColor: const Color(0xA6000000),
      transitionDuration: const Duration(milliseconds: 170),
      pageBuilder: (context, animation, secondaryAnimation) {
        return _StepOverlayDialog(step: step, copy: copy);
      },
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder<AppLanguage>(
      ...
      builder: (context, selectedLanguage, child) {
        final copy = SimulationCopy.fromLanguage(selectedLanguage);
...
class _StepOverlayDialog extends StatelessWidget {
  const _StepOverlayDialog({required this.step, required this.copy});

  final _CaseStep step;
  final SimulationCopy copy;
